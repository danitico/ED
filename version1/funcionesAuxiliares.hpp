...
namespace ed{
	...
	*/
	...
	// COMPLETAR LOS COMENTARIOS DE DOXYGEN
	void escribirVectores(ed::Vector3D const &u, ed::Vector3D const &v, ed::Vector3D const &w);//ok

	// COMPLETAR LOS COMENTARIOS DE DOXYGEN
	void observadoresDeVectores(ed::Vector3D const &u, ed::Vector3D const &v);//ok
